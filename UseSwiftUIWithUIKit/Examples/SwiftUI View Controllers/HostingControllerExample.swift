    ...
    static func getDefaultAlerts() -> [HeartHealthAlert] {
        [
            HeartHealthAlert(systemImageName: "bolt.heart.fill",
                             ...
                             description: "Notifications for irregular heart rhythms."),
            HeartHealthAlert(systemImageName: "arrow.up.heart.fill",
                             title: "High Heart Rate",
                             description: "Notifications for abnormally high heart rates."),
            HeartHealthAlert(systemImageName: "arrow.down.heart.fill",
                             title: "Low Heart Rate",
                             description: "Notifications for abnormally low heart rates.")
        ]
    }
}
        ...
        VStack(alignment: .leading) {
            ...
            if alert.isEnabled {
                Text(alert.description)
                    .font(.caption)
                    .lineLimit(1) // Work around for a known issue with multiline text sizing. For more information, see the iOS 16 Release Notes. (93685283)
            }
        }
        .padding()
